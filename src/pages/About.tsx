...
export default function About() {
    ...
    return (
        <div className="min-h-screen flex flex-col bg-slate-50">
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <div className="flex flex-col sm:flex-row justify-center gap-4">
                            ...
                            <button
                                ...
                                className="inline-flex items-center justify-center gap-2 px-8 py-4 text-base font-bold rounded-full transition-all duration-200 border-2 hover:bg-slate-50 cursor-pointer"
            ...
            {/* Lead Popup — controlled by state */}
            {isLeadPopupOpen && (
                <LeadPopup onClose={() => setIsLeadPopupOpen(false)} />
            )}
        </div>
    );
}